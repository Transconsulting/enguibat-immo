...
export class HomeComponent implements OnInit {
  ...
  activeMediaQuery = '';
  public gallery: any;
  public c= new BehaviorSubject([]) 
  public propertyTempo= this.c.asObservable();
  public slides = [];
  ...
  meuilleurAnnonce: any;
  constructor(public appSettings:AppSettings, public appService:AppService, public mediaObserver: MediaObserver, private propertieService: PropertiesService) {
  ...
  public getProperties(){
    this.propertieService.listeProperty().subscribe((data:any) => {
      ...
      this.propertieService.tab = this.propertyFunction(data);
